...
public class TestsCTAFibs extends GenericFIBTestCase {
	...
	public TestsCTAFibs(Resource fibResource, String name) {
	...
	public static VirtualModel getCTAViewPoint() throws FileNotFoundException, ResourceLoadingCancelledException, FlexoException {
		return serviceManager.getVirtualModelLibrary().getVirtualModel(CTACst.CTA_VIEWPOINT_URI);
	}
	...
	protected void initFIBComponent(FIBComponent component) {
		...
		try {
			component.setBindingFactory(new FMLFIBBindingFactory(getCTAViewPoint()));
