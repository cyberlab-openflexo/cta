 ...
 * @author yourname
 */
public class CTAContextualMenuManager extends ContextualMenuManager {

	public CTAContextualMenuManager(CTASelectionManager selectionManager, CTAController controller) {
