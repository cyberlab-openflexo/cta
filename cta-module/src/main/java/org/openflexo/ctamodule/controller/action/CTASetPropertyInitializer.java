...
public class CTASetPropertyInitializer extends ActionInitializer<SetPropertyAction, FlexoObject, FlexoObject> {

	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(ControllerActionInitializer.class.getPackage().getName());

	public CTASetPropertyInitializer(ControllerActionInitializer actionInitializer) {
