...
public class SimulationPerspectiveModuleView extends FIBModuleView<CTAProjectNature> {

	public static Resource CTA_PROJECT_MODULE_VIEW_FIB = ResourceLocator.locateResource("Fib/SimulationPerspectivePanel.fib");

	private final FlexoPerspective perspective;

	public SimulationPerspectiveModuleView(CTAProjectNature nature, FlexoController controller, FlexoPerspective perspective) {
