...
public class CTAFileMenu extends FileMenu {

	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(CTAFileMenu.class.getPackage().getName());
	...
	public CTAFileMenu(CTAController controller) {
		super(controller);
