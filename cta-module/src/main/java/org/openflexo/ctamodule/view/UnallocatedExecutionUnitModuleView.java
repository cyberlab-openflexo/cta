...
public class UnallocatedExecutionUnitModuleView extends FIBModuleView<FlexoConceptInstance> {

	public static Resource UNALLOCATED_EXECUTION_UNIT_MODULE_VIEW_FIB = ResourceLocator
			.locateResource("Fib/UnallocatedExecutionUnitPanel.fib");

	private final FlexoPerspective perspective;

	public UnallocatedExecutionUnitModuleView(FlexoConceptInstance executionUnit, FlexoController controller,
			FlexoPerspective perspective) {
		super(executionUnit, controller, UNALLOCATED_EXECUTION_UNIT_MODULE_VIEW_FIB, controller.getModule().getLocales());
