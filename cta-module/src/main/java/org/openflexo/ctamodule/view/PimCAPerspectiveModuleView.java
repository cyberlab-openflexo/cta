...
public class PimCAPerspectiveModuleView extends FIBModuleView<CTAProjectNature> {

	public static Resource CTA_PROJECT_MODULE_VIEW_FIB = ResourceLocator.locateResource("Fib/PimCAPerspectivePanel.fib");

	private final FlexoPerspective perspective;

	public PimCAPerspectiveModuleView(CTAProjectNature nature, FlexoController controller, FlexoPerspective perspective) {
