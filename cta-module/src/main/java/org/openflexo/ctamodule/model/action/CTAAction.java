...
/**
 * Abstract implementation for a {@link FlexoAction} specific to {@link CTAModule} module
 * 
 * @author sylvain
 */
public abstract class CTAAction<A extends FlexoAction<A, T1, T2>, T1 extends FlexoObject, T2 extends FlexoObject>
		extends FlexoAction<A, T1, T2> implements ModuleSpecificFlexoAction<CTAModule> {
	 ...
	 * @param editor
	 */
	public CTAAction(FlexoActionFactory<A, T1, T2> actionFactory, T1 focusedObject, List<T2> globalSelection, FlexoEditor editor) {
	 ...
	 * @param editor
	 */
	public CTAAction(T1 focusedObject, List<T2> globalSelection, FlexoEditor editor) {
	...
	public LocalizedDelegate getLocales() {
		try {
			return ((ApplicationContext) getServiceManager()).getModuleLoader().getModuleInstance(CTAModule.class).getLocales();
